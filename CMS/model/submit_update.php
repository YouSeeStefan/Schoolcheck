...
$sql = "UPDATE schools SET name = '$name', streetname = '$streetname', streetnumber = '$streetnumber', zipcode = '$zipcode', district = '$district', telnr = '$telnr', email = '$email', website = '$website', openday = '$openday', infonight = '$infonight', openclass = '$openclass', concept = '$concept' WHERE id= " .$id;
